...
class ExtraDropManager
{
   ...
   */
  static #regex: RegExp = /<drops: ?(\[(i|item|w|weapon|a|armor), ?(\d+), ?(\d+)])>/gi;

  /**
   * The {@link String.format}-able structure for the extra drop tag.
   */
  static #structure: "<drops:[{0},{1},{2}]>" = "<drops:[{0},{1},{2}]>";
